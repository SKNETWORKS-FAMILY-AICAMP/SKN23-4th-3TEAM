...
class SkinMbtiResult {
  ...
  final List<String> avoidHabits;
  final String chatbotSuggestion;
  final String imageAsset;
  final Color backgroundColor;
  final Color accentColor;

  const SkinMbtiResult({
    required this.code,
    required this.title,
    ...
    this.nightRoutine = const [],
    required this.careTips,
    required this.avoidHabits,
    required this.chatbotSuggestion,
...
const Map<String, SkinMbtiResult> skinMbtiResults = {
  'SBC': SkinMbtiResult(
    code: 'SBC',
    title: '포근포근 보송가나디',
    subtitle: '기본 보습형',
    ...
    habits:
    '스킨케어를 많이 하기보다 피부가 편안한 상태를 오래 유지하는 걸 더 중요하게 생각해요. 새로운 제품을 자주 바꾸기보다 익숙하고 무난한 제품을 오래 쓰는 편이에요.',
    morningRoutine: [
      '약산성 클렌저 또는 물세안',
      '가벼운 수분 로션 또는 수분크림',
      '데일리 선크림 고정',
    ...
    chatbotSuggestion: '기본 보습 루틴 추천받기',
    imageAsset: 'assets/images/skin_mbti/cozy_soft_dog.png',
    backgroundColor: Color(0xFFF4E6D4),
    accentColor: Color(0xFF9B7B52),
  ),
  'SBF': SkinMbtiResult(
    code: 'SBF',
    title: '진정해라냥',
    ...
    habits:
    '평소에는 루틴이 단순하지만 트러블, 붉어짐, 예민함이 생기면 진정템을 열심히 찾는 편이에요. 평소 관리보다 문제 생겼을 때 회복 모드가 더 강한 타입이에요.',
    morningRoutine: [
      '물세안 또는 아주 순한 세안',
      '진정 세럼 1개',
      '저자극 수분크림 + 순한 선크림',
    ...
    chatbotSuggestion: '피부 뒤집힘 응급 루틴 보기',
    imageAsset: 'assets/images/skin_mbti/calm_down_cat.png',
    backgroundColor: Color(0xFFE8F4D8),
    accentColor: Color(0xFF7FA35A),
  ),
  'STC': SkinMbtiResult(
    code: 'STC',
    title: '세럼 촉촉 토끼',
    ...
    habits:
    '루틴은 길지 않지만 세럼 하나, 앰플 하나는 꼭 챙기고 싶어 해요. 여러 단계를 쌓는 건 귀찮지만 효과가 느껴지는 핵심 아이템은 놓치고 싶지 않은 타입이에요.',
    morningRoutine: [
      '가벼운 수분 토너 또는 세럼',
      '저농도 기능성 세럼 1개',
      '보습제 + 선크림',
    ...
    chatbotSuggestion: '내 고민별 세럼 찾기',
    imageAsset: 'assets/images/skin_mbti/dewy_serum_bunny.png',
    backgroundColor: Color(0xFFFFF0B8),
    accentColor: Color(0xFFB08A1B),
  ),
  'STF': SkinMbtiResult(
    code: 'STF',
    title: '번쩍 케어 여우',
    ...
    habits:
    '트러블, 각질, 칙칙함, 푸석함 같은 고민이 보이면 바로 해결하고 싶어 해요. 피부를 천천히 키운다기보다 빨리 정상화하고 싶은 성향이 강한 편이에요.',
    morningRoutine: [
      '가벼운 세안',
      '수분 진정 베이스 간단히',
    ...
    chatbotSuggestion: '문제별 집중 케어 추천',
    imageAsset: 'assets/images/skin_mbti/quick_fix_fox.png',
    backgroundColor: Color(0xFFFFD4AD),
    accentColor: Color(0xFFC46F2B),
  ),
  'LBC': SkinMbtiResult(
    code: 'LBC',
    title: '든든 수호곰',
    ...
    habits:
    '토너, 세럼, 크림을 성실하게 챙기되 중심은 늘 보습과 진정에 있어요. 새 유행보다 내 피부가 편안한지가 더 중요하고, 피부가 무너지지 않게 지키는 데 강한 타입이에요.',
    morningRoutine: [
      '수분 토너',
      '진정 세럼',
      '장벽 보습제 + 선크림',
    ...
    chatbotSuggestion: '장벽 강화 루틴 보기',
    imageAsset: 'assets/images/skin_mbti/barrier_guard_bear.png',
    backgroundColor: Color(0xFFBFE5DC),
    accentColor: Color(0xFF2E8D7A),
  ),
  'LBF': SkinMbtiResult(
    code: 'LBF',
    title: '성분탐험 다람쥐',
    ...
    habits:
    '자극 없는 제품을 선호하지만 그냥 아무거나 쓰지는 않아요. 성분표, 후기, 피부타입 궁합을 꼼꼼히 보고, 순한 것 중에서도 더 잘 맞는 제품을 찾고 싶어 하는 타입이에요.',
    morningRoutine: [
      '순한 토너 또는 미스트',
      '진정 세럼 1개',
      '가벼운 보습제 + 선크림',
    ...
    chatbotSuggestion: '성분 궁합 분석하기',
    imageAsset: 'assets/images/skin_mbti/ingredient_explorer_squirrel.png',
    backgroundColor: Color(0xFFE1D0AC),
    accentColor: Color(0xFF8B6B3C),
  ),
  'LTC': SkinMbtiResult(
    code: 'LTC',
    title: '루틴 백조',
    ...
    habits:
    '기능성 제품을 무턱대고 쓰기보다 아침/저녁, 요일별, 피부 고민별로 구분해 관리하는 편이에요. 정리된 루틴을 좋아하고 질서 있게 굴러갈 때 만족도가 커요.',
    morningRoutine: [
      '가벼운 세안',
      '항산화/진정 위주 세럼',
      '보습제 + 선크림',
    ...
    chatbotSuggestion: '아침/저녁 루틴 설계하기',
    imageAsset: 'assets/images/skin_mbti/routine_swan.png',
    backgroundColor: Color(0xFFF2DDE4),
    accentColor: Color(0xFFAF6F86),
  ),
  'LTF': SkinMbtiResult(
    code: 'LTF',
    title: '열쩡햄쮜',
    ...
    habits:
    '스킨케어 관심도도 높고 신제품도 잘 찾아보며, 좋다 하면 바로 써보고 싶어 해요. 실행력이 높은 만큼 제품도 많아지고 루틴도 무거워지기 쉬운 타입이에요.',
    morningRoutine: [
    ...
    chatbotSuggestion: '내 루틴 과한지 체크하기',
    imageAsset: 'assets/images/skin_mbti/passionate_hamster.png',
    backgroundColor: Color(0xFFFFA6C9),
    accentColor: Color(0xFFD94F8A),
  ),
};